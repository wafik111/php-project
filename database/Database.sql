...
--
-- Host: localhost
-- Generation Time: Feb 12, 2019 at 04:28 PM
...
(54, 18, 'Java Programming with Sanish', 18, '2018-02-25', '172445.jpg', 'This is JavaScript Programming and is super easy...', 'java, javascript', 0, 'Publish', 19),
(55, 18, 'Java Programming with Sanish', 18, '2018-02-25', '172445.jpg', 'This is JavaScript Programming and is super easy...', 'java, javascript', 0, 'Publish', 7),
...
CREATE TABLE `users` (
  ...
  `user_role` enum('User','Subscriber','Admin') NOT NULL DEFAULT 'User',
...
INSERT INTO `users` (`user_id`, `username`, `user_password`, `user_firstname`, `user_lastname`, `user_email`, `user_image`, `user_role`, `approved`, `locked`) VALUES
(18, 'Ahmed', '$2y$10$4wJQ5vQx8DRtDHe5GmK1a.WbFLMzgJblBRgy30OnOSSl5G2.FGv72', 'Ahmed', 'Gurung', 'sanish@gmail.com', '8468-spongebob-square-pants-spongebobs-face.jpg', 'Admin', 1, 0),
(22, 'Peter', '$2y$10$iusesomecrazystrings2ui1qr860E30b0c9ijNqwCSwHnHdgz.1K', 'Peter', 'Pan', 'peter@gmail.com', '172445.jpg', 'Subscriber', 0, 0),
(24, 'Meme', '$2y$10$h.qhYZHl7k1eG/Q/nmtkVugxPMUOe4g74S51iqZwBeswBc1y27A.G', 'Ahmed', 'Elkhateeb', 'sasuke@sasuke.com', 'Deep programming.jpg', 'Subscriber', 1, 0),
(25, 'Tryagain', '$2y$10$/PUCsWy6oZSUmto6cb4CVOi5xZ/20hxL7Wr2Tj2tjcfV6p1R6ysvC', 'Minato', 'Namikaze', 'trial@trial.com', 'Deep programming.jpg', 'Subscriber', 0, 0),
(26, 'Kakashi', '$2y$10$Yjf.LyIiwaT.BMo1tkamBO6q6a2I1kYjIfQMXjMSfcgbVEx5Tk1rK', 'Hataki', 'Kakashi', 'kakashi@kakashi.com', 'Deep programming.jpg', 'Subscriber', 1, 1);
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`post_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`post_category_id`) REFERENCES `categories` (`cat_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
